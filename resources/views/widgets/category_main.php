...
<div class="category-box col-md-4 col-sm-4" style="height: 256px;margin-bottom:30px;">
    ...
    <header class="category-header bg-<?php echo $class;?> clearfix">
        <a href="<?php echo site_url('show/categoryposts/'.$parent->id.'/'.dbc_url_title(lang_key($parent->url)));?>">
    ...
    <div class="img-box-6-item category-thumb-img">
        ...
        <div class="image-style-one">
            <!-- Image -->
            <a href="<?php echo site_url('show/categoryposts/'.$parent->id.'/'.dbc_url_title(lang_key($parent->url)));?>">    <img src="<?php echo get_featured_photo_by_id($parent->featured_img); ?>" alt="" class="img-responsive">
            </a>
        </div>
    </div>
</div>
