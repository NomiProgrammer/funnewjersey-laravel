...
<div class="s-widget">
    <!-- Heading -->
    <p style="font-weight:bold;font-family: 'chunkfiveroman', sans-serif; color:#094971; font-size:14px;"><i class="fa fa-folder color"></i>&nbsp; Featured Attractions</p>
    <!-- Widgets Content -->
    <div class="widget-content hot-properties">
        <?php if($query->num_rows()<=0){?>
            <div class="alert alert-info">Want your business featured here? Call: 732-298-6015</div>
        <?php }else{?>
