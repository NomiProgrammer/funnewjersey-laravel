...
@section('page_title', 'Add Web Email Settings')
...
@section('admin-content')
    @php
        $pageName = 'Add Web Email Settings';
        $pageName2 = 'Add New Web Email Settings Records';
    @endphp
...
<form action="{{ route('admin.system.settings.save') }}" method="POST">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            ...
            <input type="text" name="contact_email" class="form-control" placeholder="Type something"
        ...
        <div class="col-md-6 mb-3">
            <label>Webadmin Name</label>
            <input type="text" name="webadmin_name" class="form-control" placeholder="Type something"
                value="{{ old('webadmin_name', $settings['webadmin_name'] ?? '') }}" required>
            @error('webadmin_name') <small class="text-danger">{{ $message }}</small> @enderror
        </div>

        <div class="col-md-6 mb-3">
            <label>Webadmin Email</label>
            <input type="text" name="webadmin_email" class="form-control" placeholder="Type something"
                value="{{ old('webadmin_email', $settings['webadmin_email'] ?? '') }}" required>
            @error('webadmin_email') <small class="text-danger">{{ $message }}</small> @enderror
        </div>
