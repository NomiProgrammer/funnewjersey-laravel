...
@section('page_title', 'Manage Mega Menus')
...
@section('admin-content')
    @php
        $pageName = 'Manage Mega Menus';
        $pageName2 = 'Mega Menus Records';
    @endphp
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{route('mega_menus.create')}}" class="float-right btn btn-block btn-success btn-sm">
...
columns: [
    ...
    <script>
        $(document).on('click', '.delete-mega', function(e) {
            e.preventDefault();

            let id = $(this).data('id');
            if (confirm('Are you sure you want to delete this Mega Meus?')) {
                $.ajax({
                    url: "{{ url(app()->getLocale() . '/admin/mega_menus/destroy') }}/" + id,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
