...
@section('page_title', 'Manage Blog Articles Trash')
...
@section('admin-content')
    @php
        $pageName = 'Manage Blog Articles Trash';
        $pageName2 = 'Blog Articles Trash Records';
    @endphp
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{route('blog.create')}}" class="float-right btn btn-block btn-success btn-sm">
...
<script>
    ...
    <script>
    $(document).on('click', '.force-delete-blog', function(e) {
        e.preventDefault();

        let id = $(this).data('id');
        let url = "{{ url(app()->getLocale() . '/admin/blog/force-delete') }}/" + id;
...
<script>
    $(document).on('click', '.restore-blog', function(e) {
        e.preventDefault();

        let id = $(this).data('id');
        let url = "{{ url(app()->getLocale() . '/admin/blog/restore') }}/" + id;
