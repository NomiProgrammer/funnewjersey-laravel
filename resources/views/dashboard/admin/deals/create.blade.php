...
@section('admin-content')
    @php
        $pageName = 'Add Deals ';
        $pageName2 = 'Add New Deals  Records';
    @endphp
    ...
    <div class="card-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" required name="title" placeholder="Enter Deal Title" value="{{ old('title') }}">
            </div>

            {{-- Deal % Off or Discount --}}
            <div class="form-group col-md-6">
                <label for="price">Deal % Off or Discount</label>
                <input type="text" class="form-control" required name="price" placeholder="Enter Discount" value="{{ old('price') }}">
            </div>

            {{-- Deal Limit --}}
            <div class="form-group col-md-6">
                <label for="deal_limit">Deal Limit</label>
                <input type="number" class="form-control" required name="deal_limit" placeholder="Enter Deal Limit" value="{{ old('deal_limit') }}">
            </div>

            {{-- Terms & Conditions --}}
            <div class="form-group col-md-12">
                <label for="terms">Terms & Conditions</label>
                <textarea required name="terms" id="content" class="form-control" rows="4">{{ old('terms') }}</textarea>
            </div>
            ...
            <div class="form-group col-md-6">
                ...
                <input type="file" class="form-control" required name="featured_img">
                <small class="text-muted">Image will be uploaded to: <code>front_assets/uploads/deals/</code></small>
            </div>
