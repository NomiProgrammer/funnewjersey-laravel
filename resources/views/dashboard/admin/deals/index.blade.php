...
@section('page_title', 'Manage Deals')
...
@section('admin-content')
    @php
        $pageName = 'Manage Deals';
        $pageName2 = 'Deals Records';
    @endphp
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{route('deals.create')}}" class="float-right btn btn-block btn-success btn-sm">
...
columns: [
    ...
    <script>
        $(document).on('click', '.delete-deal', function(e) {
            ...
            let id = $(this).data('id');
            if (confirm('Are you sure you want to delete this Deals?')) {
                $.ajax({
                    url: "{{ url(app()->getLocale() . '/admin/deals/destroy') }}/" + id,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
