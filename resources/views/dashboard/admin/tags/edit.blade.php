...
@section('admin-content')
    @php
        ...
        $pageName2 = 'Edit New Invoice Records';
    @endphp
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <select  name="parent" class="form-control">
                    ...
                    <option value="3" {{ $tag->parent == 3 ? 'selected' : '' }}>Historical Places</option>
                    <option value="4" {{ $tag->parent == 4 ? 'selected' : '' }}>Kid Friendly Attraction</option>
                </select>
            </div>
            <div class="col-md-6 mb-3">
