...
@section('page_title', 'Manage Custom Meta Tags')
...
@section('admin-content')
    @php
        $pageName = 'Manage Custom Meta Tags';
        $pageName2 = 'Custom Meta Tags Records';
    @endphp
                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{route('meta_tags.create')}}" class="float-right btn btn-block btn-success btn-sm">
...
<script>
   ...
   <script>
        $(document).on('click', '.delete-metas', function(e) {
            e.preventDefault();

            let id = $(this).data('id');
            if (confirm('Are you sure you want to delete this Metas?')) {
                $.ajax({
                    url: "{{ url(app()->getLocale() . '/admin/meta_tags/destroy') }}/" + id,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
