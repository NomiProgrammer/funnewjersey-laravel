...
@section('admin-content')
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input type="text" id="meta_title" name="seo_settings[meta_title]"
                value="{{ old('seo_settings.meta_title', $seo['meta_title'] ?? '') }}" class="form-control">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="crawl_after" name="seo_settings[crawl_after]"
                value="{{ old('seo_settings.crawl_after', $seo['crawl_after'] ?? '') }}" class="form-control">
        </div>
