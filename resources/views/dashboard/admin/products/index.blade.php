                        ...
                        <div class="card card-info">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <a href="{{route('products.create')}}" class="float-right btn btn-block btn-success btn-sm">
    ...
    <script>
        $(document).on('click', '.delete-product', function(e) {
            ...
            if (confirm('Are you sure you want to delete this Product?')) {
                $.ajax({
                    url: "{{ url(app()->getLocale() . '/admin/products/destroy') }}/" + id,
                    type: 'DELETE',
                    data: {
                        _token: '{{ csrf_token() }}'
                    },
