                    ...
                    <div class="col-12">
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('banners-ads.update', $banner->id) }}" method="POST"
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="slide_order" class="form-control"
                                                value="{{ old('slide_order', $banner->slide_order) }}" required>
                                        </div>

                                        <div class="form-group">
                                            <label>Current Image</label><br>
                                            @if ($banner->featured_img)
                                                <img src="{{ asset('storage/' . $banner->featured_img) }}"
                                                    alt="Featured Image" style="max-height: 150px;">
                                            @endif
                                        </div>
                                            ...
                                            <select name="assigned_to" class="form-control">
                                                ...
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}"
                                                        {{ $banner->assigned_to == $user->id ? 'selected' : '' }}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="status" class="form-control" required>
                                                <option value="1" {{ $banner->status == 1 ? 'selected' : '' }}>
                                                    Published</option>
                                                <option value="2" {{ $banner->status == 2 ? 'selected' : '' }}>Drafted
                                                </option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="created_by" class="form-control">
                                                ...
                                                @foreach ($users as $user)
                                                    <option value="{{ $user->id }}"
                                                        {{ $banner->created_by == $user->id ? 'selected' : '' }}>
                                                        {{ $user->first_name }} {{ $user->last_name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                            ...
                                            <select name="state" class="form-control" required>
                                                @foreach ($states as $state)
                                                    <option value="{{ $state->id }}"
                                                        {{ $banner->state == $state->id ? 'selected' : '' }}>
                                                        {{ $state->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="category" class="form-control" required>
                                                @foreach ($categories as $cat)
                                                    <option value="{{ $cat->id }}"
                                                        {{ $banner->category == $cat->id ? 'selected' : '' }}>
                                                        {{ $cat->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="expires" class="form-control"
                                                value="{{ old('expires', $banner->expires) }}">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type" class="form-control" required>
                                                <option value="1" {{ $banner->type == '1' ? 'selected' : '' }}>Top
                                                    Horizontal</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="region" class="form-control" required>
                                                <option value="1" {{ $banner->region == '1' ? 'selected' : '' }}>
                                                    North NJ</option>
                                                <option value="2" {{ $banner->region == '2' ? 'selected' : '' }}>
                                                    South NJ</option>
                                                <option value="3" {{ $banner->region == '3' ? 'selected' : '' }}>
                                                    Southern NJ</option>
                                            </select>
                                        </div>
                                    </div>
